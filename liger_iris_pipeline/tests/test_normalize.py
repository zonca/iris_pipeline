...
def test_normalize():
    ...
    input_model = liger_iris_pipeline.datamodels.LigerIrisImageModel(data=np.random.rand(4096, 4096))
    ...
    for method in [None, "mean", "median", "mode"]:
        ...
        if method is None:
            ...
            expected_output_data = input_model.data / scipy.stats.mode(input_model.data, axis=None).mode
